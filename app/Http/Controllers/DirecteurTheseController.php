...
class DirecteurTheseController extends Controller
{
    ...
    {
        return response()->json(DirecteurThese::all(), 200);
    }
    ...
    public function store(Request $request)
    {
        ...
        $equipeRecherche = DirecteurThese::create($validated);
        return response()->json($equipeRecherche, 201);
    }

    public function show(DirecteurThese $id)
    {
        return response()->json($id, 200);
    }

    public function update(Request $request, DirecteurThese $id)
    {
        $validated = $request->validate([
                'first_name' => 'required|string|max:255',
                'last_name' => 'required|string|max:255',
    ...
    public function destroy(DirecteurThese $id)
    {
        $id->delete();
